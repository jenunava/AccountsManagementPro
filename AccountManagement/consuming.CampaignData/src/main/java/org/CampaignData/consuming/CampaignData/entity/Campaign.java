...
public class Campaign {
	...
	public String toString() {
		return "Campaign => [id = " + id + "] name = " + name + ", advertiser = " + advertiser + ", cpm = " + cpm
				+ ", startDate = " + startDate + ", endDate = " + endDate + ", Total Clicks = " + getTotalClicks()
				+ ", Total Impressions = " + getTotalImpressions() + ", Total Conversions = " + getTotalConversions()
				+ ", Total Views = " + getTotalViews() + ", Creative Names = " + getCreativeNames() + ".";
	}
